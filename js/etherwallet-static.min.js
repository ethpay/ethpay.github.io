!function () {
    ...
    function r() {
        var t = Math.floor(360 * e()), r = 60 * e() + 40 + "%", o = 25 * (e() + e() + e() + e()) + "%", i = "hsl(" + t + "," + r + "," + o + ")";
        return i
    }

    function o(t) {
        for (var r = t, o = t, i = Math.ceil(r / 2), n = r - i, a = [], s = 0; s < o; s++) {
    ...
    function i(t, e, r, o, i) {
        ...
        n.width = n.height = a * r;
        var s = n.getContext("2d");
        s.fillStyle = o, s.fillRect(0, 0, n.width, n.height), s.fillStyle = e;
        for (var l = 0; l < t.length; l++) {
            var h = Math.floor(l / a), u = l % a;
            s.fillStyle = 1 == t[l] ? e : i, t[l] && s.fillRect(u * r, h * r, r, r)
        }
        return n
    }
    ...
    function n(e) {
        e = e || {};
        var n = e.size || 8, a = e.scale || 4, s = e.seed || Math.floor(Math.random() * Math.pow(10, 16)).toString(16);
        t(s);
        var l = e.color || r(), h = e.bgcolor || r(), u = e.spotcolor || r(), d = o(n), c = i(d, l, a, h, u);
        return c
    }
    ...
    var t = function (t, e) {
        ...
        var t = document.documentElement.getBoundingClientRect(), e = window.innerWidth || t.right - Math.abs(t.left);
        return e
    };
    t.prototype = {
        init: function () {
            ...
            this.open = function () {
                ...
                /in
                /.test(this.modal.className)?document.removeEventListener("keydown",e,!1):document.addEventListener("keydown",e,!1)},this.trigger=function(){var e=document.querySelectorAll('[data-toggle="modal"]'),r=e.length,o=0;for(o;o<r;o++)e[o].addEventListener("click",function(e){var r=e.target,o=r.getAttribute("data-target")&&r.getAttribute("data-target").replace("#","")||r.getAttribute("href")&&r.getAttribute("href").replace("#","");document.getElementById(o)===t.modal&&t.open()})},this._resize=function(){var t=this.overlay||document.querySelector(".modal-backdrop"),e={w:document.documentElement.clientWidth+"px",h:document.documentElement.clientHeight+"px"};null!==t&&/i
                n /
                .
                test(t.className) && (t.style.height = e.h, t.style.width = e.w)
...
!function () {
    ...
    function s(t, e) {
        for (var r = 1, o = l(t), i = 0, n = m.length; n >= i; i++) {
            var a = 0;
            switch (e) {
                case u.L:
                    a = m[i][0];
    ...
    t.prototype = {
        ...
        addData: function (e) {
            ...
            for (var n = 0; n < this.modules.length; n++)for (var a = n * i, s = 0; s < this.modules[n].length; s++) {
                var l = s * i, h = this.modules[n][s];
                h && (o.beginFill(0, 100), o.moveTo(l, a), o.lineTo(l + i, a), o.lineTo(l + i, a + i), o.lineTo(l, a + i), o.endFill())
            }
            return o
            ...
            for (var r = this.errorCorrectLevel << 3 | e, o = c.getBCHTypeInfo(r), i = 0; 15 > i; i++) {
                var n = !t && 1 == (1 & o >> i);
            ...
            for (var r = -1, o = this.moduleCount - 1, i = 7, n = 0, a = this.moduleCount - 1; a > 0; a -= 2)for (6 == a && a--; ;) {
                for (var s = 0; 2 > s; s++)if (null == this.modules[o][a - s]) {
                    ...
                    var h = c.getMask(e, o, a - s);
                    h && (l = !l), this.modules[o][a - s] = l, i--, -1 == i && (n++, i = 7)
                }
        ...
        for (var a = o.getRSBlocks(t, r), s = new i, l = 0; l < n.length; l++) {
            var h = n[l];
            s.put(h.mode, 4), s.put(h.getLength(), c.getLengthInBits(h.mode, t)), h.write(s)
        }
        ...
        for (var o = 0, i = 0, n = 0, a = new Array(e.length), s = new Array(e.length), l = 0; l < e.length; l++) {
            var h = e[l].dataCount, u = e[l].totalCount - h;
            i = Math.max(i, h), n = Math.max(n, u), a[l] = new Array(h);
            for (var d = 0; d < a[l].length; d++)a[l][d] = 255 & t.buffer[d + o];
            o += h;
            var f = c.getErrorCorrectPolynomial(u), g = new r(a[l], f.getLength() - 1), m = g.mod(f);
            s[l] = new Array(f.getLength() - 1);
            for (var d = 0; d < s[l].length; d++) {
                var p = d + m.getLength() - s[l].length;
                s[l][d] = p >= 0 ? m.get(p) : 0
            }
        }
        for (var v = 0, d = 0; d < e.length; d++)v += e[d].totalCount;
        for (var y = new Array(v), _ = 0, d = 0; i > d; d++)for (var l = 0; l < e.length; l++)d < a[l].length && (y[_++] = a[l][d]);
        for (var d = 0; n > d; d++)for (var l = 0; l < e.length; l++)d < s[l].length && (y[_++] = s[l][d]);
        return y
    };
    for (var h = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, u = {
        L: 1,
        M: 0,
        Q: 3,
        H: 2
        ...
        getLostPoint: function (t) {
            for (var e = t.getModuleCount(), r = 0, o = 0; e > o; o++)for (var i = 0; e > i; i++) {
                for (var n = 0, a = t.isDark(o, i), s = -1; 1 >= s; s++)if (!(0 > o + s || o + s >= e))for (var l = -1; 1 >= l; l++)0 > i + l || i + l >= e || (0 != s || 0 != l) && a == t.isDark(o + s, i + l) && n++;
                n > 5 && (r += 3 + n - 5)
            }
            for (var o = 0; e - 1 > o; o++)for (var i = 0; e - 1 > i; i++) {
                var h = 0;
                t.isDark(o, i) && h++, t.isDark(o + 1, i) && h++, t.isDark(o, i + 1) && h++, t.isDark(o + 1, i + 1) && h++, (0 == h || 4 == h) && (r += 3)
            }
            ...
            for (var u = 0, i = 0; e > i; i++)for (var o = 0; e > o; o++)t.isDark(o, i) && u++;
    ...
    r.prototype = {
        get: function (t) {
            ...
            for (var e = new Array(this.getLength() + t.getLength() - 1), o = 0; o < this.getLength(); o++)for (var i = 0; i < t.getLength(); i++)e[o + i] ^= f.gexp(f.glog(this.get(o)) + f.glog(t.get(i)));
            return new r(e, 0)
        }, mod: function (t) {
            if (this.getLength() - t.getLength() < 0)return this;
            for (var e = f.glog(this.get(0)) - f.glog(t.get(0)), o = new Array(this.getLength()), i = 0; i < this.getLength(); i++)o[i] = this.get(i);
            for (var i = 0; i < t.getLength(); i++)o[i] ^= f.gexp(f.glog(t.get(i)) + e);
        ...
        for (var i = r.length / 3, n = [], a = 0; i > a; a++)for (var s = r[3 * a + 0], l = r[3 * a + 1], h = r[3 * a + 2], u = 0; s > u; u++)n.push(new o(l, h));
        return n
    ...
    var m = [[17, 14, 11, 7], [32, 26, 20, 14], [53, 42, 32, 24], [78, 62, 46, 34], [106, 84, 60, 44], [134, 106, 74, 58], [154, 122, 86, 64], [192, 152, 108, 84], [230, 180, 130, 98], [271, 213, 151, 119], [321, 251, 177, 137], [367, 287, 203, 155], [425, 331, 241, 177], [458, 362, 258, 194], [520, 412, 292, 220], [586, 450, 322, 250], [644, 504, 364, 280], [718, 560, 394, 310], [792, 624, 442, 338], [858, 666, 482, 382], [929, 711, 509, 403], [1003, 779, 565, 439], [1091, 857, 611, 461], [1171, 911, 661, 511], [1273, 997, 715, 535], [1367, 1059, 751, 593], [1465, 1125, 805, 625], [1528, 1190, 868, 658], [1628, 1264, 908, 698], [1732, 1370, 982, 742], [1840, 1452, 1030, 790], [1952, 1538, 1112, 842], [2068, 1628, 1168, 898], [2188, 1722, 1228, 958], [2303, 1809, 1283, 983], [2431, 1911, 1351, 1051], [2563, 1989, 1423, 1093], [2699, 2099, 1499, 1139], [2809, 2213, 1579, 1219], [2953, 2331, 1663, 1273]], p = function () {
    ...
    }(), v = "svg" === document.documentElement.tagName.toLowerCase(), y = v ? p : n() ? function () {
        function t() {
        ...
        if (this._android && this._android <= 2.1) {
            ...
            CanvasRenderingContext2D.prototype.drawImage = function (t, e, i, n, a, s, l, h) {
                if ("nodeName" in t && /img/i.test(t.nodeName))for (var u = arguments.length - 1; u >= 1; u--)arguments[u] = arguments[u] * r; else"undefined" == typeof h && (arguments[1] *= r, arguments[2] *= r, arguments[3] *= r, arguments[4] *= r);
        ...
        return i.prototype.draw = function (t) {
            var e = this._elImage, r = this._oContext, o = this._htOption, i = t.getModuleCount(), n = o.width / i, a = o.height / i, s = Math.round(n), l = Math.round(a);
            e.style.display = "none", this.clear();
            for (var h = 0; i > h; h++)for (var u = 0; i > u; u++) {
                var d = t.isDark(h, u), c = u * n, f = h * a;
                r.strokeStyle = d ? o.colorDark : o.colorLight, r.lineWidth = 1, r.fillStyle = d ? o.colorDark : o.colorLight, r.fillRect(c, f, n, a), r.strokeRect(Math.floor(c) + .5, Math.floor(f) + .5, s, l), r.strokeRect(Math.ceil(c) - .5, Math.ceil(f) - .5, s, l)
            }
            this._bIsPainted = !0
        ...
        return t.prototype.draw = function (t) {
            for (var e = this._htOption, r = this._el, o = t.getModuleCount(), i = Math.floor(e.width / o), n = Math.floor(e.height / o), a = ['<table style="border:0;border-collapse:collapse;">'], s = 0; o > s; s++) {
                a.push("<tr>");
                for (var l = 0; o > l; l++)a.push('<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' + i + "px;height:" + n + "px;background-color:" + (t.isDark(s, l) ? e.colorDark : e.colorLight) + ';"></td>');
                a.push("</tr>")
            }
            a.push("</table>"), r.innerHTML = a.join("");
            var h = r.childNodes[0], u = (e.width - h.offsetWidth) / 2, d = (e.height - h.offsetHeight) / 2;
